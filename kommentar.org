...
Bericht durchlesen [fn:6] oder direkt die dabei entstandenen
Programme anschauen, alle lassen sich auf Github finden und sind unter
offenen Lizensen einfach weiterzuverwenden[fn:1]. Auch muss angemerkt werden, dass viele der dabei
...
- Signaling: In Netzwerken ist es immer eine grosse Frage, wie neue
...
- Form: Durch regelmässige Abfragen und überprüfungen können sich
...
- Actaeon: \\
  ...
  beispielsweise =CJDNS= anzubieten. Auch existiert aktuell noch keine
...
- Orion: \\
  ...
  werden: Auch wenn einer /offizieller/ Client existiert, so hält einen
...
entwickelt. Stattdessen kam aus diesem Projekt verschiedene /relativ/
