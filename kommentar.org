...
- Schriftlicher Kommentar: In diesem Dokument hier findet sich eine
  ...
  aber oberflächlichen Einblick in das Project Orion. Natürlich wird
...
Arbeiten dieser Arbeit sollen in zwei Abschnitte getrennt werden,
wobei die meisten Produkte aus der zweiten Phase hervorgingen. Trotzdem
darf die erste Entwicklungsphase 
** Modularität
...
- Ein möglichst vielseitig einsetzbares Nachrichtensystem basierend
  ...
  Anwendungen sowie öffentlich angeboten. Entwickelt in Rust sollen
