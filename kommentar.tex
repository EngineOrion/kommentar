...
etwas genauer im Abschnitt \hyperref[sec:orgc445ca4]{Abhängigkeit} besprochen.
...
\section{Produkt}
\label{sec:orgca65dd9}
\subsection{Actaeon}
\label{sec:org91e5efe}
\subsection{Orion}
\label{sec:orgdfb0aab}
\subsection{Anwendungen}
\label{sec:orgf3d84ae}
\end{document}
